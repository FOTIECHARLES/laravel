...
class ReservationSeeder extends Seeder
{
    ...
    {  
        ...
        //    2 résavations avec des données statiques 
        $reservationDatas = [
            [
                'nom'=>'Foo',
                'prenom'=>'Foo',
        ...
        // // 48 reservations avec des données
        for ($i=0; $i< 48; $i++) {
            ...
            // // jour avec une date comprise entre -6 mois et +6mois
            // $datetime= $faker->dateTimeBetween('-6 months','+6months');
